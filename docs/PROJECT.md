...
- **Mobile-First**: Primary access via mobile phone browser. UI must be responsive and optimized for mobile performance with a lightweight bundle (Svelte + Vite + Tailwind keep it inherently small).
